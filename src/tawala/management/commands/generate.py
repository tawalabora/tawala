...
class EnvFileGenerator(FileGenerator):
    ...
    Creates a .env file in the Tawala project base directory with all
    ...
    def data(self) -> str:
        ...
        lines = [
            ...
            "# " + "=" * 78,
            "#",
            "# This file contains all available environment variables for your Tawala project.",
        ]
        ...
        for idx, (class_name, fields) in enumerate(sorted(fields_by_class.items())):
            ...
            for field in fields:
                ...
                if toml_key:
                    lines.append(f"# * TOML: [tool.tawala.{toml_key}]")

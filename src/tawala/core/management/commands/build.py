...
Executes build commands defined in Tawala settings (BUILD.commands).
    ...
    def print_no_commands_error(self) -> None:
        ...
        self.command.stdout.write(
            self.command.style.WARNING(
                ...
                "   .env: BUILD_COMMANDS = ['command1', 'command2', ...]\n"
                "   toml: build = { commands = ['command1', 'command2', ...]}\n"
            )
        )
        self.command.stdout.write("")
...
class Command(BaseCommand):
    ...
    help = "Execute build commands defined in settings.BUILD.commands"
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        build_setting: dict[str, list[str]] = getattr(settings, "BUILD", {})
        build_commands: list[str] = build_setting.get("commands", [])
